...
### P2 — ошибки в чате (ядро DONE @ede1c57; console/5xx — остаток)
...
- [ ] (остаток) сбор JS-console + app-5xx + НАТУРАЛЬНЫЙ build-error триггер (модель пишет битый код) E2E — не покрыто этим заходом.
