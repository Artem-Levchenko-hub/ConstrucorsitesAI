...
- Judge an optimization by accepted live scenarios, elapsed time, rework, and model calls together. Keep it only when correctness and coverage hold and the completed result becomes cheaper or faster; lower token counts alone are not success.
