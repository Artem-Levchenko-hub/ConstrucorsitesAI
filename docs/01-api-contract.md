...
Изменение этого файла вносится в том же PR, что реализация и тесты, с согласия ответственных за затронутые компоненты; обратно совместимо либо с планом миграции (раздел 1 [`AGENTS.md`](../AGENTS.md)).
