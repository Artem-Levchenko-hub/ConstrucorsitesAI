...
> **Статус: история, не обязательно к чтению при старте.** Протокол рутины от 09.06.2026.
...
> пути), действует общий регламент [`AGENTS.md`](../../AGENTS.md). Не создавать и не возобновлять описанные автономные рутины в текущем виде
> без отдельного решения владельца, согласованного с `AGENTS.md`.
