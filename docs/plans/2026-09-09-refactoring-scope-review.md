...
Task5 extension от9 сентября устраняет её через существующий materializer после
проверки consumers, frozen golden, export/rollback и установленного wheel:
net −52 181 bytes/−25 строк. [Текущий статус проверки и доставки](2026-09-09-task5-anime-verification.md).
