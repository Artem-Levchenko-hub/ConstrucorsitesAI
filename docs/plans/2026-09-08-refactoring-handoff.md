...
> Продолжение от 13 сентября: [свежая сверка и поставки](2026-09-13-refactoring-continuation.md). Ниже сохранён исторический статус 9 сентября; его runtime SHA и запреты restore не являются текущими.
