...
from yleum_orchestrator.schemas.workspace import (
...
from yleum_orchestrator.services.cell_draft_support import (
    signed_preview_session_url,
    trusted_template_source,
)
from yleum_orchestrator.services.cell_state import CellWorkspaceState
from yleum_orchestrator.services.docker_cell_resources import DockerCellResourceManager
...
def _owner_resume_epochs(runtime: Any, state: CellWorkspaceState) -> tuple[int | None, int | None]:
    ...
    """
    from yleum_orchestrator.services.machine_adapter import serving_resume_epochs
...
async def _prepare_portable_write(
    ...
    from yleum_orchestrator.services.machine_identity import machine_identity_root
...
def _workspace_exec_spec(state: CellWorkspaceState, *, state_path: str) -> _WorkspaceExecSpec:
    from yleum_orchestrator.services.cell_deletion import is_workspace_deleted
