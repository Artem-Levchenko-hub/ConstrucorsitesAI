...
from yleum_orchestrator.services import nginx_writer, remote_deploy

log = structlog.get_logger("yleum_orchestrator.byo")
...
async def sync_remote_routes(
    ...
    _verify_token(x_internal_token)
    from yleum_orchestrator.services.builder import _remote_port
