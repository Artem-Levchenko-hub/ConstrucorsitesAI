...
from yleum_orchestrator.services.restoration_data_contract import Diagnostic
...
# Same rules as apps/api/src/yleum_api/services/versioning_capabilities.py; the
