...
from yleum_orchestrator.services.project_machine import machine_effect, write_controller_json
...
class DockerActivationOfferAdapter:
    ...
    async def materialize(
        ...
        from yleum_orchestrator.services.code_restoration_engine import validate_supported_runtime
