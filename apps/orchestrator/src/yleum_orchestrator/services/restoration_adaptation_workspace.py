...
_RULE_NAME = re.compile(r"^[a-z][a-z0-9_; ]{0,399}$")
...
_log = structlog.get_logger("yleum_orchestrator.restoration_adaptation")
...
class DockerAdaptationWorkspaceEngine:
    ...
    def _rehearser(self) -> Any:
        if self._probe_rehearser is None:
            from yleum_orchestrator.services.code_restorations import (
