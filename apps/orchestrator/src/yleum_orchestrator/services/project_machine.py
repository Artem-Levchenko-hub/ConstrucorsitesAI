...
from yleum_orchestrator.core.project_machine import MachineCommand, MachineManifest
from yleum_orchestrator.services.cell_state import _ensure_secure_dir, _read_plain_json_file
