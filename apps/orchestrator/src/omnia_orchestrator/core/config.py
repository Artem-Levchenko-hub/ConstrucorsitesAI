...
class Settings(BaseSettings):
    ...
    # Production is independent of the editor, with its own admitted budget.
    cell_public_bundle_cpu_cores: float = Field(default=1.0, ge=1)
    cell_public_bundle_memory_bytes: int = Field(default=1024**3, ge=512 * 1024**2)
    cell_public_machine_cpu_cores: float = Field(default=0.5, ge=0.25)
