...
export const metadata: Metadata = {
  title: "Yleum Realtime",
  description: "Realtime application built on Yleum.",
};
  ...
  return (
    <html lang="ru" className="dark">
      ...
      <body className="min-h-screen bg-background text-foreground antialiased">
        {children}
        {/* Yleum select-mode inspector — canonical copy of apps/api
        ...
        {/* Yleum viral "Remix this" CTA — top-level public viewer only (hidden
            inside the owner-workspace iframe). Drift-synced. */}
        <Script src="/omnia-remix-cta.js" strategy="afterInteractive" />
        {/* Yleum brief-narration — "AI is designing" reveal. Inert without a
