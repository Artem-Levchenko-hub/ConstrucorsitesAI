...
// - `hmr.clientPort: 443` because Yleum's nginx terminates TLS and the
...
export default defineConfig({
  ...
  server: {
    ...
    strictPort: true,
    hmr: { clientPort: 443 },
    // `true` = accept ANY Host header. Required because Yleum's preview-render
    ...
    // container binds 127.0.0.1 only and is reachable solely via Yleum's nginx
