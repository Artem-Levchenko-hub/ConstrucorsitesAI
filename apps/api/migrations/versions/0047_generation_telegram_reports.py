"""Add durable development generation Telegram report state.

Revision ID: 0047_generation_telegram_reports
Revises: 0046_project_memory
"""
...
revision: str = "0047_generation_telegram_reports"
down_revision: str | None = "0046_project_memory"
