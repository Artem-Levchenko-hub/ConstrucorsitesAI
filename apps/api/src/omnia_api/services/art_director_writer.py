...
ВИЗУАЛ (КАЖДАЯ секция несёт ≥1 из 3 инструментов; плоская заливка/один линейный градиент без визуала = брак. Комбинируй, НЕ только фото. Для каждой секции в спеке укажи строкой «ВИЗУАЛ: <А/Б/В + точные классы/мотив>»):
  (А) РИСОВАННАЯ ГРАФИКА — тематический инлайн-SVG-рисунок под нишу (НЕ фото). СПРОЕКТИРУЙ ≥1–2 СИЛЬНЫХ вектор-момента на странице (в ключевых секциях, не в каждой). Точно: мотив (под нишу — суши→волна 波 / палочки / восходящее-солнце-лучи / силуэт рыбы одной линией), стиль (line-art ИЛИ геометрия ИЛИ крупная абстракция — НЕ фотореализм), масштаб (КРУПНО, во весь блок), цвет (акцент + тон-в-тон), где сидит и поверх чего. Премиально и чисто; НЕ клипарт, НЕ эмодзи, НЕ детский рисунок. viewBox задан.
