...
ФОН-ГРАФИКА (КАЖДАЯ секция — ЗАРЯЖЕННЫЙ фон, НЕ монотонный цвет и НЕ дешёвый линейный градиент): hero + ≥2 ключевые секции — НАСТОЯЩИЙ тематический фон <img data-omnia-gen="<детальный EN-prompt: предмет, сцена, свет, настроение, ракурс, объектив; без текста и логотипов>"> full-bleed ЗА контентом + затемняющий overlay (контраст ≥4.5:1), класс .depth-3/.img-zoom. ОСТАЛЬНЫЕ секции — СПРОЕКТИРОВАННАЯ граф-композиция, РАЗНАЯ от секции к секции (НЕ механически одинаковая на всех): .omnia-shader data-omnia-colors="#..,#..,#..,#.." (ТОН-В-ТОН, одна хью-семья) | мягкие .orb-блики тон-в-тон (z-0 под контентом) | .bg-mesh | .line-grid/.dot-grid дозой | декор-SVG/blob | глубокий градиент с .grain-фактурой. Для КАЖДОЙ секции укажи, ЧЕМ именно заряжен фон. Плоская заливка или один линейный градиент без фактуры = брак.
