...
КАРТИНКА: <img data-omnia-gen="<детальный prompt: предмет, сцена, стиль, свет, ракурс, объектив>"> — где стоит и с какими классами (.img-zoom/.depth-3)
...
— ЗАПРЕЩЕНО generic-AI: центрованный текст + три одинаковые карточки + одна кнопка + пустой фон.
