...
from omnia_api.services.generation.agent_messages import _agent_step_budget
from omnia_api.services.generation.agent_preparation import persist_build_plan
    ...
    *,
    ...
    if _is_continue:
        ...
        if project_info.template == "max_miniapp":
            from omnia_api.services.max_generation_contract import build_max_product_contract
