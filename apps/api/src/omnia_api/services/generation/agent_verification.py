...
async def check_backend_and_normalize_css(
    *,
    ...
    try:
        ...
        from omnia_api.services.backend_guardrail import check_backend as _check_backend
        ...
        def _backend_verdict() -> GuardrailVerdict:
            ...
            if project_info.template == "max_miniapp":
                from omnia_api.services.max_generation_contract import unsafe_max_backend_paths
    ...
    if project_info.template == "max_miniapp" and "src/app/globals.css" in files:
        try:
            from omnia_api.services.max_generation_contract import normalize_max_globals_css
