...
② data-omnia-photo → СТОК-ФОТО (БЕСПЛАТНО) — ВСЁ ОСТАЛЬНОЕ реальное фото:
   сотрудники/команда, товары/продукты, услуги, портреты-отзывы, интерьер,
   галерея, блюда, атмосфера, фоны не-hero секций.
...
кафе, клиника): 1 hero-фон data-omnia-gen + 4–8 data-omnia-photo (команда, товары,
услуги, галерея, атмосфера). Сайт такого типа без единого реального фото = провал.
