...
• Один ответ может изменить до 100 файлов, до 2 МБ на файл. Это лимит только
  одного ответа модели: за последовательные итерации проект может содержать
  до 5000 файлов (суммарно до 64 МБ).
