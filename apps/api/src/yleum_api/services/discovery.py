...
_SYSTEM = (
    "Ты — продуктовый дизайнер Yleum, который ведёт КОРОТКИЙ дружелюбный диалог-"
...
_PLAN_SYSTEM = (
    "Ты — продуктовый дизайнер Yleum. Пользователь прислал ПЕРВЫЙ запрос на "
...
_RESULT_TYPE_SYSTEM = (
    "Ты — продуктовый аналитик Yleum. Пользователь прислал ПЕРВЫЙ запрос на "
