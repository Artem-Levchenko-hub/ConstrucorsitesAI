...
Each gate owns its own browser session (it needs its own viewport, auth state and
resolver rules); what it must NOT own is the navigation, which is why the helper
below is the only door to a settled page.
"""
