...
async def append_adaptation_context(
    ...
    return (
        ...
        + (
            ...
            "tests and promotion. Whatever you write while testing, leave the isolated copy "
            "exactly as you found it: remove the rows you created and undo the values you "
            "changed before you finish. The proof is taken from that same copy and compared "
            "with the owner's live data, so a single leftover test row is refused as "
            "'candidate_business_data_changed' and costs a whole repair round. "
