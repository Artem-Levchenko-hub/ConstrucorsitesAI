  ...
  return (
    <div className="mt-1" onKeyDown={closeOnEscape}>
      <button
        ...
        className="flex min-h-11 w-full items-center gap-3 rounded-[8px] px-3 py-2.5 text-left text-fg-secondary transition-colors hover:bg-surface-base hover:text-fg-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1 focus-visible:ring-offset-surface-raised"
      >
          ...
          {accountLinks.map(([href, Icon, label], index) => (
            ...
            >
              <Link
                href={href}
                tabIndex={open ? 0 : -1}
                className="flex min-h-9 items-center gap-2.5 rounded-[7px] px-2.5 text-[11px] text-fg-secondary transition-colors hover:bg-surface-base hover:text-fg-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-1 focus-visible:ring-offset-surface-raised"
              >
