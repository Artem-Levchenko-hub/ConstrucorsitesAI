...
export function VerifyMaxEmail({ token }: { token: string }) {
  ...
  return (
    <div className="w-full max-w-md rounded-[28px] border border-white/10 bg-[#141620] p-8 text-center">
      <div className="mx-auto flex size-12 items-center justify-center rounded-2xl bg-[#7569ff]/15 text-[#a69fff]">
      ...
      {state !== "loading" && (
        <Button asChild className="mt-6 h-11 rounded-xl bg-[#6f5cf5]">
