    ...
    >
      ...
      >
        <div className="flex h-16 items-center justify-between border-b border-[#d8d4cb] px-5">
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className="grid size-11 place-items-center rounded-[8px] text-[#8d887f] lg:hidden"
        ...
        >
          <Link
            href="/max"
            className="flex h-11 items-center gap-3 rounded-[8px] px-3 text-xs text-[#6d6962] hover:bg-[#f5f3ee]"
          >
            ...
            {maxProjects.map((item) => {
              ...
              return (
                <Link
                  key={item.id}
                  href={`/max/${item.id}`}
                  className={`flex h-11 items-center gap-3 rounded-[8px] px-3 text-xs transition ${active ? "bg-[#ece8df] font-medium" : "text-[#6d6962] hover:bg-[#f5f3ee]"}`}
                >
        ...
        <div className="shrink-0 border-t border-[#d8d4cb] p-3">
          <Link
            href="/account"
            className="flex min-h-11 min-w-0 items-center gap-2.5 rounded-[8px] p-2 hover:bg-[#f5f3ee]"
          >
            <span className="grid size-8 shrink-0 place-items-center rounded-full bg-[#171716] text-[11px] font-semibold text-white">
            ...
            <span className="min-w-0 flex-1">
              ...
              <span className="block truncate text-[9px] text-[#8d887f]">
                {email}
              </span>
            </span>
          ...
          <form action={logoutAction} className="mt-1">
            <button
              type="submit"
              className="flex min-h-11 w-full items-center gap-2 rounded-[8px] px-2 text-[10px] text-[#8d887f] hover:bg-[#f5f3ee]"
            >
        ...
        <header className="flex h-16 shrink-0 items-center justify-between gap-2 border-b border-[#d8d4cb] px-3 sm:px-5">
          <div className="flex min-w-0 items-center gap-1 sm:gap-3">
            <button
              ...
              className="grid size-11 shrink-0 place-items-center rounded-[8px] text-[#6d6962] lg:hidden"
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 flex items-center gap-1.5 text-[9px] text-[#8d887f]">
                <span className="size-1.5 rounded-full bg-[#248a4b]" />
          ...
          <div className="flex shrink-0 items-center gap-1.5 sm:gap-2">
            <Link
              ...
              className="hidden h-11 items-center rounded-[8px] border border-[#d8d4cb] px-3 text-xs text-[#6d6962] hover:bg-[#f5f3ee] md:inline-flex"
            >
              Интеграции
            </Link>
            <button
            ...
            <button
              ...
              className="inline-flex h-11 items-center gap-1.5 rounded-[8px] bg-[#f15a38] px-3 text-xs font-semibold text-white hover:bg-[#d94929] sm:gap-2 sm:px-4"
            >
