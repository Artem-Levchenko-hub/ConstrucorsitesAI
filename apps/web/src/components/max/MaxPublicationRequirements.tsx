...
export const PUBLICATION_REQUIREMENTS = [
  ...
  { id: "legal", title: "Документы приложения", description: "Проверьте политику и условия приложения и подтвердите их во вкладке «Политики».", action: "Подтвердить" },
...
export function MaxPublicationRequirements({ projectId, items, status }: {
  ...
  return <div className="max-publication-requirements">
    ...
    <section className="max-publication-optional" aria-label="Можно заполнить позже">
      ...
      <p>Дополнительное описание, аудитория, оформление и каталог не блокируют публикацию в Yleum. Реквизиты компании Yleum не запрашивает: бизнес проверяет сам MAX при выдаче токена бота. Название и описание уже сохранены из вашей идеи — заполнять их заново не нужно.</p>
    ...
    <section className="max-publication-after" aria-label="После публикации">
      <div><h3>После публикации</h3><p>Вставьте полученный адрес приложения в кабинет MAX и подтвердите это в Yleum. До публикации адрес не требуется.</p></div>
