...
export function MaxPublicationRequirements({ projectId, items, status }: {
  ...
  return <div className="max-publication-requirements">
    ...
    <section className="max-publication-optional" aria-label="Можно заполнить позже">
      ...
      <p>Дополнительное описание, аудитория, оформление и каталог не блокируют публикацию в Studio. Реквизиты компании Studio не запрашивает: бизнес проверяет сам MAX при выдаче токена бота. Название и описание уже сохранены из вашей идеи — заполнять их заново не нужно.</p>
