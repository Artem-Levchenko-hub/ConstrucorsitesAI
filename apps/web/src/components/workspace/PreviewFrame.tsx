    ...
    <div className="flex flex-col h-full bg-surface-base">
      <div className="h-10 flex items-center justify-between px-4 gap-3">
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {visible?.commit_sha && (
            <span className="ml-1 hidden text-[11px] font-mono text-fg-tertiary min-[1400px]:inline">
        ...
        <div className="flex items-center gap-1">
          ...
          {viewMode === "preview" && (
            <>
              <span className="ml-1 hidden select-none text-[11px] font-medium text-fg-tertiary min-[1400px]:inline">
                Править
              </span>
              <Button
                size="sm"
              ...
              >
                ...
                <span className="hidden min-[1400px]:inline">С ИИ</span>
              </Button>
              ...
              >
                ...
                <span className="hidden min-[1400px]:inline">Вручную</span>
              </Button>
              ...
              >
                ...
                <span className="hidden min-[1400px]:inline">Hero</span>
              </Button>
          ...
          <Button size="sm" variant="ghost" asChild>
            <a href={publicUrl} target="_blank" rel="noreferrer">
              ...
              <span className="hidden min-[1400px]:inline">Открыть</span>
            </a>
          </Button>
