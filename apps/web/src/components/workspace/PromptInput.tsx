...
export function PromptInput({
  ...
  return (
    ...
    >
      ...
      <div className="rounded-lg border border-border-default bg-surface-input transition-all focus-within:border-accent/70 focus-within:shadow-[0_0_0_3px_var(--color-accent-subtle)]">
        <textarea
          ref={ref}
