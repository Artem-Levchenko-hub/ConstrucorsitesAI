...
export function ProductComingSoon({
  ...
  return (
    <div
      data-marketing
      className="min-h-svh bg-[#080a10] text-white antialiased"
    >
      <header className="border-b border-white/[0.1] bg-[#080a10]">
      ...
      <main className="mx-auto grid min-h-[calc(100svh-65px)] max-w-[1440px] lg:grid-cols-[minmax(0,1.15fr)_minmax(400px,0.85fr)]">
        <section className="flex flex-col px-5 py-12 sm:px-8 lg:border-r lg:border-white/[0.1] lg:px-12 lg:py-16 xl:px-16">
          <div className="flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.14em] text-[#8b5cf6]">
            <Clock3 className="h-4 w-4" />
            {en ? "In development" : "В разработке"}
          </div>
          <div className="my-auto py-16">
            <span className="mb-8 flex h-12 w-12 items-center justify-center rounded-xl border border-blue-400/20 bg-blue-400/[0.06] text-blue-400">
          ...
          <div className="flex flex-wrap gap-3 border-t border-white/[0.1] pt-6">
            <Link
              href="/"
              className="inline-flex h-11 items-center gap-2 rounded-lg border border-[#334166] bg-[#0f121f] px-4 text-sm font-medium text-white/65 hover:border-blue-400/50 hover:text-white"
            >
            ...
            <Link
              href="/max"
              className="inline-flex h-11 items-center gap-2 rounded-lg bg-[#3b82f6] px-4 text-sm font-semibold text-white hover:bg-[#2563eb]"
            >
        ...
        <aside className="flex flex-col bg-[#13172a] p-6 text-white sm:p-8 lg:p-10">
