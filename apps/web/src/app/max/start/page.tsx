...
const steps = [
  ...
  {
    number: "04",
    title: "Подключите MAX-бота",
    text: "Создайте и промодерируйте бота в MAX Partner, затем вставьте его секрет в Omnia.",
    result: "API бота отвечает, секрет сохранён защищённо.",
  ...
  },
  {
    ...
    text: "Вставьте URL в MAX Partner, активируйте webhook и откройте приложение двумя пользователями.",
    result: "Чистый путь проходит внутри MAX без ручного исправления данных.",
