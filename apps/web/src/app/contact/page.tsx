      ...
      <div className="grid gap-5 lg:grid-cols-3">
        {[
          ...
          <article key={title} className="rounded-2xl border border-[#202946] bg-[#13172a] p-7">
            ...
            <p className="mt-2 min-h-12 text-[14px] leading-6 text-[#94a3b8]">{text}</p>
            <Link href={href} className="mt-7 inline-flex items-center gap-2 text-[13px] font-semibold text-[#7ba7ff]">
              {label}
