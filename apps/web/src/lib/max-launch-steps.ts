...
const STEP_INSTRUCTIONS: Record<string, string> = {
  ...
  max_business: "Подтвердите владельца в Omnia. Верификация в MAX Partner остаётся отдельным внешним действием.",
  plan: "Подключите Pro для production-хостинга и запуска в MAX.",
  bot: "Вставьте секрет прошедшего модерацию MAX-бота и проверьте подключение.",
  publish: "Запустите публикацию: студия подготовит постоянный HTTPS-адрес.",
  webhook: "После публикации активируйте webhook для подключённого MAX-бота.",
