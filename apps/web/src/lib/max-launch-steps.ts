...
const STEP_INSTRUCTIONS: Record<string, string> = {
  business: "Перед публичным запуском укажите владельца и email поддержки. Дополнять описание, оформление и каталог необязательно.",
  legal: "Проверьте сведения для документов и подтвердите их корректность перед публикацией.",
